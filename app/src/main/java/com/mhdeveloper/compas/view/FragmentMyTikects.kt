 ...
 * [FragmentMyTikects.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FragmentMyTikects.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class FragmentMyTikects : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view =  inflater.inflate(R.layout.fragment_fragment_my_tikects, container, false)
        recycler= view.findViewById(R.id.recycler)
        var adapter = AdapterMyTickets(this.tickets,view.context, activity as MainActivity?)
        eventData = FirestoreController.getMyTickets(MngRooms.getRoomSelected().uid,MngRooms.getUser().tag).addSnapshotListener(
    ...
    companion object {
         ...
         * @returned A new instance of fragment FragmentMyTikects.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentMyTikects().apply {
